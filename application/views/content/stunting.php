...
<div class="right_col" role="main">
    <div class="page-title">
      <div class="title_left">
        <h3>Stunting <small>Laman Data Stunting</small></h3>
      </div>
    </div>  
<!--Content-->
<div class="row">
  ...
  <div class="x_panel">
                  <div class="x_title">
                      ...
                      <ul class="nav navbar-right panel_toolbox">
                        ...
                        <li><a class="collapse-link"></i></a></li> -->
                        <li>
                          <a href="<?php echo site_url('c_kesehatan/add_stunting'); ?>">
    ...
    <div class="x_content"> 
      <form action="<?php echo site_url('c_kesehatan/delete_stunting');?>" method="post" id="form-detele">
        ...
        ?>
                  ...
                  ?>  
                    <tr>
                        ...
                        <a>
                          <button type="button" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#modal_delete<?php echo $data['id_stunting']; ?>" data-placement="top" title="Hapus Data Pasien"><i class="glyphicon glyphicon-trash"></i> Hapus</button>
                        </a>
                        ...
                        <div class="modal-dialog modal-sm">
                          <div class="modal-content">
                            ...
                            <div class="modal-footer">
                              ...
                              <a href="<?php echo site_url()."c_kesehatan/hapus_stunting/".$data['id_stunting'];?>" class="btn btn-danger"><i class="glyphicon glyphicon-trash"></i> Hapus</a>
                            </div>
